...
${!inputPath?.endsWith("/src/index.webc") ? `<template data-island="once"><script type="module" src="/js/wa-copy-button.js"${inputPath?.endsWith(".webc") ? " webc:keep" : ""}></script></template>` : ""}
</is-land>` : ""}`;
